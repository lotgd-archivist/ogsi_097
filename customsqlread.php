...
page_header("SQL Custom Lookups");
output("`c`bEnter your SELECT Query`b`c`n");
addnav("SQL Lookup Refresh","su_sql.php");
addnav("G?Superuser Grotto","superuser.php");
...
$_POST[sql]=str_replace("\'","'",$_POST[sql]);
    ...
    output("`n<input type=submit value=Lookup>",true);
    output("</form>",true);
