...
if ($_GET['op']=="") {
   ...
   addnav("`@Prosegui","gnomogemme.php?op=goon");
   addnav("`\$Lascia perdere","gnomogemme.php?op=leave");
   ...
   addnav("Torna alla Foresta","forest.php");
      ...
      addnav("`@Voglio giocare","gnomogemme.php?op=anothergem");
      addnav("`\$Nah, non mi interessa","gnomogemme.php?op=exit");
      $session['user']['specialinc']="gnomogemme.php";
   ...
   if ($session['user']['gems'] < $session['gemtopay']){
      ...
      $session['user']['specialinc']="gnomogemme.php";
      addnav("Scegli un numero tra 1 e $basedice","gnomogemme.php?op=number6");
   }
// First try with 6 faces dice
   ...
   output("<form action='gnomogemme.php?op=number6bis' method='POST'><input name='number' value='0'><input type='submit' class='button' value='Scegli Numero'>`n",true);
   $session['user']['specialinc']="gnomogemme.php";
   addnav("","gnomogemme.php?op=number6bis");
   ...
   if ($number < 1 OR $number > $basedice){
      ...
      if ($match == $number) {
         output("`\$Arghhh !! `#Vinto tu hai. Io do te 3 gemme che tu vinto ha, ma tu deve ancora fare ");
         output("una scelta obbligatoriamente, solo dopo ritirare potrai`n");
         $session['gemwin'] += 3;
         $session['user']['specialinc']="gnomogemme.php";
         addnav("Scegli un numero tra 1 e ".($basedice+1),"gnomogemme.php?op=number7");
      }else if (($number-1) == $match OR ($number+1) == $match) {
         output("`\$Arghhh !! `#Tuo numero vicino numero di faccia dado. Io do te 2 gemme che tu vinto ha, ");
         ...
         $session['gemwin'] = 0;
         $session['user']['specialinc']="gnomogemme.php";
         addnav("Fammi riprovare","gnomogemme.php?op=anothergem");
         addnav("Sei un imbroglione, me ne vado!","gnomogemme.php?op=exit");
      }
   }
//Second try with 7 faces dice
   ...
   output("<form action='gnomogemme.php?op=number7bis' method='POST'><input name='number' value='0'><input type='submit' class='button' value='Scegli Numero'>`n",true);
   $session['user']['specialinc']="gnomogemme.php";
   addnav("","gnomogemme.php?op=number7bis");
   ...
   if ($number < 1 OR $number > ($basedice+1)){
      ...
      if ($match == $number) {
         ...
         $session['user']['specialinc']="gnomogemme.php";
         addnav("Mi ritiro, ho vinto abbastanza","gnomogemme.php?op=exit");
         addnav("Mi sento fortunato, proseguo","gnomogemme.php?op=number8");
      }else if (($number-1) == $match OR ($number+1) == $match) {
         $session['gemwin'] *= 2;
...
//Third try with 8 faces dice
   ...
   output("<form action='gnomogemme.php?op=number8bis' method='POST'><input name='number' value='0'><input type='submit' class='button' value='Scegli Numero'>`n",true);
   $session['user']['specialinc']="gnomogemme.php";
   addnav("","gnomogemme.php?op=number8bis");
   ...
   if ($number < 1 OR $number > ($basedice+2)){
      output("`2Lo gnomo ti guarda storto e dice \"`#Numero tra 1 e ".($basedice+2)." tu scegliere deve. Tu detto `b`%$number`b`# che numero giusto non è!`2\"`n");
       $session['user']['specialinc']="gnomogemme.php";
      addnav("Scegli un numero tra 1 e ".($basedice+2),"gnomogemme.php?op=number7");
   }else{
      output("`2\"`#Scelto tu hai `b`%$number`b`#, ora io lancio dado e noi vediamo se tu vinto hai`2\"`n");
      ...
      if ($match == $number) {
         ...
         $session['user']['specialinc']="gnomogemme.php";
         addnav("Mi ritiro, ho vinto abbastanza","gnomogemme.php?op=exit");
         addnav("Mi sento fortunato, proseguo","gnomogemme.php?op=number9");
      }else if (($number-1) == $match OR ($number+1) == $match) {
         $session['gemwin'] *= 2;
         output("`\$Arghhh !! `#Tuo numero vicino numero di faccia dado. Io do te {$session['gemwin']} gemme che tu vinto ha, ");
         output("se tu vuole ora può continuare a giocare o se preferisca può ritirare vincita.`n");
...
//Forth try with 9 faces dice
   ...
   output("<form action='gnomogemme.php?op=number9bis' method='POST'><input name='number' value='0'><input type='submit' class='button' value='Scegli Numero'>`n",true);
   $session['user']['specialinc']="gnomogemme.php";
   addnav("","gnomogemme.php?op=number9bis");
   ...
   if ($number < 1 OR $number > ($basedice+3)){
      output("`2Lo gnomo ti guarda storto e dice \"`#Numero tra 1 e ".($basedice+3)." tu scegliere deve. Tu detto `b`%$number`b`# che numero giusto non è!`2\"`n");
       $session['user']['specialinc']="gnomogemme.php";
      addnav("Scegli un numero tra 1 e ".($basedice+3),"gnomogemme.php?op=number9");
   }else{
      output("`2\"`#Scelto tu hai `b`%$number`b`#, ora io lancio dado e noi vediamo se tu vinto hai`2\"`n");
      ...
      if ($match == $number) {
         ...
         $session['user']['specialinc']="gnomogemme.php";
         addnav("Mi ritiro, ho vinto abbastanza","gnomogemme.php?op=exit");
         addnav("Mi sento fortunato, proseguo","gnomogemme.php?op=number10");
      }else if (($number-1) == $match OR ($number+1) == $match) {
         $session['gemwin'] *= 2;
         output("`\$Arghhh !! `#Tuo numero vicino numero di faccia dado. Io do te {$session['gemwin']} gemme che tu vinto ha, ");
         output("se tu vuole ora può continuare a giocare o se preferisca può ritirare vincita.`n");
...
//Fifth try with 10 faces dice
   ...
   output("<form action='gnomogemme.php?op=number10bis' method='POST'><input name='number' value='0'><input type='submit' class='button' value='Scegli Numero'>`n",true);
   $session['user']['specialinc']="gnomogemme.php";
   addnav("","gnomogemme.php?op=number10bis");
   ...
   if ($number < 1 OR $number > ($basedice+4)){
      output("`2Lo gnomo ti guarda storto e dice \"`#Numero tra 1 e ".($basedice+4)." tu scegliere deve. Tu detto `b`%$number`b`# che numero giusto non è!`2\"`n");
       $session['user']['specialinc']="gnomogemme.php";
      addnav("Scegli un numero tra 1 e ".($basedice+4),"gnomogemme.php?op=number10");
   }else{
      output("`2\"`#Scelto tu hai `b`%$number`b`#, ora io lancio dado e noi vediamo se tu vinto hai`2\"`n");
      ...
      if ($match == $number) {
         ...
         $session['user']['specialinc']="gnomogemme.php";
         addnav("Mi ritiro, ho vinto abbastanza","gnomogemme.php?op=exit");
         addnav("Mi sento fortunato, proseguo","gnomogemme.php?op=number11");
      }else if (($number-1) == $match OR ($number+1) == $match) {
         $session['gemwin'] *= 2;
         output("`\$Arghhh !! `#Tuo numero vicino numero di faccia dado. Io do te {$session['gemwin']} gemme che tu vinto ha, ");
         output("se tu vuole ora può continuare a giocare o se preferisca può ritirare vincita.`n");
...
// Sixth try with 11 faces dice
   ...
   output("<form action='gnomogemme.php?op=number11bis' method='POST'><input name='number' value='0'><input type='submit' class='button' value='Scegli Numero'>`n",true);
   $session['user']['specialinc']="gnomogemme.php";
   addnav("","gnomogemme.php?op=number11bis");
}else if ($_GET['op']=="number11bis") {
   $number = intval($_POST['number']);
   if ($number < 1 OR $number > ($basedice+5)){
      output("`2Lo gnomo ti guarda storto e dice \"`#Numero tra 1 e 11 tu scegliere deve. Tu detto `b`%$number`b`# che numero giusto non è!`2\"`n");
       $session['user']['specialinc']="gnomogemme.php";
      addnav("Scegli un numero tra 1 e ".($basedice+5),"gnomogemme.php?op=number11");
   }else{
      output("`2\"`#Scelto tu hai `b`%$number`b`#, ora io lancio dado e noi vediamo se tu vinto hai`2\"`n");
      ...
      if ($match == $number) {
         ...
         $session['user']['specialinc']="gnomogemme.php";
         addnav("Ritira Vincita","gnomogemme.php?op=exit");
      }else if (($number-1) == $match OR ($number+1) == $match) {
         $session['gemwin'] *= 2;
         output("`\$Arghhh !! `#Tuo numero vicino numero di faccia dado. Io do te {$session['gemwin']} gemme che tu vinto ha, ");
   ...
   if ($session['gemwin'] == 0) {
      ...
      output("Felice per la vincita etc etc");
      ...
      //fare verifica su disponibilità gemme dello gnomo ....
   }
   $session['user']['specialinc']="";
