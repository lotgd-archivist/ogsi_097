...
define('MP_NEW_MOON_NAME','Luna Nuova');
define('MP_NEW_MOON_ID',0);
define('MP_WAXING_CRESCENT_NAME','Luna Crescente');
define('MP_WAXING_CRESCENT_ID',1);
define('MP_FIRST_QUARTER_NAME','Primo Quarto');
define('MP_FIRST_QUARTER_ID',2);
define('MP_WAXING_GIBBOUS_NAME','Gibbosa Crescente');
define('MP_WAXING_GIBBOUS_ID',3);
define('MP_FULL_MOON_NAME','Luna Piena');
define('MP_FULL_MOON_ID',4);
define('MP_WANING_GIBBOUS_NAME','Gibbosa Calante');
define('MP_WANING_GIBBOUS_ID',5);
define('MP_THIRD_QUARTER_MOON_NAME','Ultimo Quarto');
define('MP_THIRD_QUARTER_MOON_ID',6);
define('MP_WANING_CRESCENT_NAME','Luna Calante');
...
function moonPhase($timeStamp = -1) {
    ...
    $this->someFullMoonDate = strtotime("June 11 2006 18:03 UT");
