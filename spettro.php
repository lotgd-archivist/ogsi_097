...
if ($battle){
  include("battle.php");
    if ($victory){
        ...
        output("`&Dopo tutte le botte che gli hai dato non si alzerà mai più ... mah tanto è incorporeo.`n");
        output("`2Hai vinto!! È stata dura ma sei riuscito a ucciderlo.`n");
        output("`n`2Lo spettro aveva 2000 monete.`n");
        output("`n`n`2Forse ucciderlo non è stata una buona idea, ma hai guadagnato $exp punti esperienza .  ");
