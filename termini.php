...
`#3.5`6 Alcuni utenti che dispongono di privilegi particolari, definiti “moderatori” possono intervenire per silenziare temporaneamente da LoGD gli account il cui comportamento non sia conforme ai termini dell’Accordo o alle norme della Netiquette. La cancellazione definitiva dell’account in caso ne ricorressero le condizioni, verrà effettuato esclusivamente dagli Admin di LoGD secondo le condizioni di cui al punto 3.3.`n`n
